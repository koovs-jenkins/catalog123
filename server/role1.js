export const all_roles = {
  ...
  articlecms: [
    {
      icon: "pages",
      permission_name: "articlecms_category_access",
      name: "Category",
      url: "/articlecms/category",
    },
    {
      icon: "",
      permission_name: "articlecms_post_access",
      name: "Post",
      url: "/articlecms/posts"
    },
    {
      icon: "",
      permission_name: "articlecms_create_post_access",
      name: "Create Post",
      url: "/articlecms/post/add"
    },
    {
      icon: "",
      permission_name: "articlecms_role_access",
      name: "Role",
      url: "/articlecms/role"
    },
    {
      icon: "",
      permission_name: "articlecms_keyword_access",
      name: "Keyword",
      url: "/articlecms/keywords"
    },
    {
      icon: "",
      permission_name: "articlecms_media_access",
      name: "Media",
      url: "/articlecms/media"
    },
    {
      icon: "",
      permission_name: "articlecms_template_access",
      name: "Template",
      url: "/articlecms/templates"
    },
  ],
  payment: [
    {
