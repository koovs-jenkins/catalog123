...
function createLMv2Response(type2message, username, ntlmhash, nonce) {
	let buf = new Buffer(24),
		ntlm2hash = createNTLMv2Hash(ntlmhash, username, type2message.targetName),
...
function createNTLMv2Response(type2message, username, ntlmhash, nonce) {
