...
import CreateBrand from "./containers/brand/create";
import CreateKoovsBrand from "./containers/brand/create_koovs";
import ListBrand from "./containers/brand/list";
import ListRoles from "./containers/roles/list";
import CreateRoles from "./containers/roles/create";
import AssignEditRoles from "./containers/roles/assignEdit";
import AssignRoles from "./containers/roles/assign";
import CreateParentCategory from "./containers/category/create_parent";
import ListParentCategory from "./containers/category/list_parent";
import CreateChildCategory from "./containers/category/create_child";
import ListChildCategory from "./containers/category/list_child";
import CreateAttribute from "./containers/attribute/create";
import ListAttribute from "./containers/attribute/list";
import CreateAttributeValue from "./containers/attributevalue/create";
import ListAttributeValue from "./containers/attributevalue/list";
import CreateProducts from "./containers/product/create";
import IndexProducts from "./containers/product/indexproduct";
import BatchProduct from "./containers/product/batchproduct";
import ListProducts from "./containers/product/list";
import AddProductMeasurement from "./containers/product/addmeasurement";
import ListMeasurement from "./containers/product/listmeasurement";
import MapMeasurement from "./containers/product/addprodmeasure";
import ViewProduct from "./containers/product/view";
import ViewLogs from "./containers/product/logs";
import AddProductImages from "./containers/product/addimages";
import SkuStatus from "./containers/Catalogue/SkuStatus";
import AddColorCode from "./containers/Catalogue/AddColorCode";
import MapColorCode from "./containers/Catalogue/MapColorCode";
import HsnMapping from "./containers/Catalogue/HsnMapping";
import ShopTheLookCreate from "./containers/ShopTheLook/create";
import ShopTheLookList from "./containers/ShopTheLook/list";
import SapManagement from "./containers/sap/sapmanagement";
import ListGenericPromo from "./containers/promo/list_generic_promo";
import AddGenericPromo from "./containers/promo/create_generic_promo";
import ListUserPromo from "./containers/promo/list_user_promo";
import AddUserPromo from "./containers/promo/create_user_promo";
import ListPromotionalPromo from "./containers/promo/list_promotional_promo";
import AddPromotionalPromo from "./containers/promo/create_promotional_promo";
import ListBankOfferPromo from "./containers/promo/list_bank_offer_promo";
import ListBankOfferPromoCache from "./containers/promo/bank_offer_cache";
import AddBankOfferPromo from "./containers/promo/create_bank_offer_promo";
import MultiUserPromo from "./containers/promo/multiuserpromo";
import sizeMap from "./containers/sizeMap/index";
import NotAuthorized from "./containers/NotAuthorized/not_authorized";
import PromoListActive from "./containers/promo/PromoListActive";
import VMUploadCSVPage from "./containers/virtualMerchandise/UploadCSV";
